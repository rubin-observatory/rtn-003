...
There will undoubtedly be proposals in between. There are some criteria that any IDAC must meet, in order to comply with Rubin Observatory data policy. These are given in \secref{sec:anyDAC}.
