...
\author   {William O'Mullane, Beth Willman, Melissa Graham, Leanne Guy, Robert Blumi, Phil Marshall }
...
\setDocChangeRecord{%
  ...
  \addtohist{1.1}{2020-08-05}{Fix some inconsistancies }{WOM}
}
